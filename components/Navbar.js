...
export default function Navbar() {
	...
	useEffect(() => {
	  ...
	  widthl=ref.current.offsetWidth;
	 
	}, []);
	let clickHandler=(e) => navRef.current.classList.remove("hidden");
	...
	<header className="sticky top-0 z-50">
       <nav ref={ref} className="relative px-4 py-4 flex justify-between items-center bg-white">
		<a className="text-3xl font-bold leading-none" href="#">
			...
			<img src="logo-2022.svg" alt="An SVG of an eye" />
		</a>
		<div className="lg:hidden">
			<button onClick={clickHandler} className="navbar-burger flex items-center text-blue-600 p-3">
		...
		<ul className="hidden absolute top-1/2 left-1/2 transform -translate-y-1/2 -translate-x-1/2 lg:flex lg:mx-auto lg:flex lg:items-center lg:w-auto lg:space-x-6">
			...
			<li><a className="text-sm text-gray-400 hover:text-gray-500" href="#">Order Now</a></li>
			<li className="text-gray-300">
    ...
    <div ref={navRef} className="mob-navbar navbar-menu relative z-50 hidden">
		...
		<nav className="fixed top-0 left-0 bottom-0 flex flex-col w-5/6 max-w-sm py-6 px-6 bg-white border-r overflow-y-auto">
			<div className="flex items-center mb-8">
				...
				<button onClick={onAddClick} className="navbar-close">
